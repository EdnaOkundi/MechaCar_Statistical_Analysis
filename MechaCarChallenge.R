...
library(tidyverse)
mecha_mpg <- read.csv(file='C:/Users/Admin/Desktop/Class_Folder/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F)
...
mecha_coil <- read.csv(file='C:/Users/Admin/Desktop/Class_Folder/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
